<?php
includeComponents("inc.header")
?>
       <!-- Hero Start -->
<div class="section techwix-hero-section" style="background-image: url(<?=asset('assets/images/bg/hero-bg1.png')?>);">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7">
                ...
                <div class="hero-images">
                    <div class="images">
                        <img src="<?=asset('assets/images/hero-img1.png')?>" alt="">
                    </div>
                </div>
                <!-- Hero Image ennd -->
            </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-sm-6">
                        ...
                        <div class="service-item service-01">
                            <div class="service-img">
                                <img src="<?=asset('assets/images/ser-icon1.png')?>" alt="">
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6">
                        ...
                        <div class="service-item">
                            <div class="service-img">
                                <img src="<?=asset('assets/images/ser-icon2.png')?>" alt="">
                            </div>
                            <div class="service-content">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        ...
                        <div class="service-item service-03">
                            <div class="service-img">
                                <img src="<?=asset('assets/images/ser-icon3.png')?>" alt="">
                            </div>
                            <div class="service-content">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        ...
                        <div class="service-item">
                            <div class="service-img">
                                <img src="<?=asset('assets/images/ser-icon4.png')?>" alt="">
                            </div>
                            <div class="service-content">
...
<div class="section techwix-cta-section section-padding">
    <div class="container">
        <div class="cta-wrap">
            <div class="cta-icon">
                <img src="<?=asset('assets/images/cta-icon1.png')?>" alt="">
            </div>
...
<!-- About Start -->
<div class="section techwix-about-section section-padding" style="background-image: url(<?=asset('assets/images/bg/about-bg.png')?>);">
                ...
                <div class="swiper-container case-study-active">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="single-case-study">
                                <div class="case-study-img">
                                    <a href="#"><img src="<?=asset('assets/images/case-1.jpg')?>" alt=""></a>
                                    <div class="top-meta d-none">
                                        <img src="<?=asset('assets/images/case-meta1.png')?>" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-case-study">
                                <div class="case-study-img">
                                    <a href="#"><img src="<?=asset('assets/images/case-2.jpg')?>" alt=""></a>
                                    <div class="top-meta d-none">
                                        <img src="<?=asset('assets/images/case-meta2.png')?>" alt="">
                                    </div>
                                </div>
                                <div class="case-study-content">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-case-study">
                                <div class="case-study-img">
                                    <a href="#"><img src="<?=asset('assets/images/case-3.jpg')?>" alt=""></a>
                                    <div class="top-meta d-none">
                                        <img src="<?=asset('assets/images/case-meta3.png')?>" alt="">
                                    </div>
                                </div>
                                <div class="case-study-content">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="testimonial-img">
                        <div class="shape-1">
                            <img src="<?=asset('assets/images/shape/testi-shape1.png')?>" alt="">
                        </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-testimonial">
                                        <img src="<?=asset('assets/images/testi-icon.png')?>" alt="">
