...
<!-- Page Banner End -->
 ...
 <div class="section techwix-choose-us-section techwix-choose-us-section-04 section-padding">
        ...
        <div class="section techwix-cta-section-04 techwix-cta-section-06 techwix-cta-section-07">
            <div class="container">
                <div class="cta-wrap" style="background-image: url(<?=asset('assets/images/bg/cta-bg5.jpg')?>);">
        ...
        <!-- Testimonial Start  -->
        <div class="section bg-cover techwix-testimonial-section-02 techwix-testimonial-section-03 techwix-testimonial-section-05" style="background-image: url(assets/images/bg/testi-bg4.jpg);">
            <div class="container">
