...
?>
 <!-- Page Banner Start -->
 <div class="section page-banner-section" style="background-image: url(<?=asset('assets/images/bg/page-banner.jpg')?>);">
            <div class="shape-1">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-img-wrap">
                                <img class="shape-1" src="<?=asset('assets/images/shape/about-shape2.png')?>" alt="">
                                <div class="about-img">
        ...
        <div class="section techwix-counter-section-03 techwix-counter-section-04">
            <div class="container">
                <div class="counter-wrap" style="background-image: url(<?=asset('assets/images/bg/counter-bg2.jpg')?>);">
                    <div class="row">
        ...
        <!-- Choose Us Start -->
        <div class="section techwix-choose-us-section section-padding" style="background-image: url(<?=asset('assets/images/bg/choose-us-bg3.jpg')?>);">
            <div class="container">
                    ...
                    <div class="choose-us-content-wrap">
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    <div class="choose-us-img">
                                        <img src="<?=asset('assets/images/ser-icon9.png')?>" alt="">
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    <div class="choose-us-img">
                                        <img src="<?=asset('assets/images/ser-icon10.png')?>" alt="">
                                    </div>
                                    <div class="choose-us-content">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    <div class="choose-us-img">
                                        <img src="<?=asset('assets/images/ser-icon21.png')?>" alt="">
                                    </div>
                                    <div class="choose-us-content">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    <div class="choose-us-img">
                                        <img src="<?=asset('assets/images/ser-icon22.png')?>" alt="">
                                    </div>
                                    <div class="choose-us-content">
        ...
        <!-- Team Start -->
        <div class="section techwix-team-section techwix-team-section-02 section-padding" style="background-image: url(<?=asset('assets/images/bg/team-bg1.jpg')?>);">
            <div class="container">
                <!-- Team Wrap Start -->
                <div class="team-wrap">
                    <div class="section-title text-center">
        ...
        <div class="section techwix-cta-section-02 section-padding-02">
            <div class="container">
                <!-- Cta Wrap Start -->
                <div class="cta-wrap" style="background-image: url(<?=asset('assets/images/bg/cta-bg.jpg')?>);">
                    <div class="row align-items-center">
                        <div class="col-xl-9 col-lg-8">
                            <!-- Cta Content Start -->
                            <div class="cta-content">
                                <div class="cta-icon">
                                    <img src="<?=asset('assets/images/cta-icon2.png')?>" alt="">
                                </div>
